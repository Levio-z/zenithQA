...
import com.zenith.qa.mapper.AppMapper;
import com.zenith.qa.model.dto.app.AppQueryRequest;
import com.zenith.qa.model.entity.App;
import com.zenith.qa.model.entity.User;
import com.zenith.qa.model.enums.AppScoringStrategyEnum;
import com.zenith.qa.model.enums.AppTypeEnum;
import com.zenith.qa.model.enums.ReviewStatusEnum;
import com.zenith.qa.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(AppTypeEnum.getEnumByCode(appType) == null, ErrorCode.PARAMS_ERROR,"应用类型非法");

            ThrowUtils.throwIf(AppScoringStrategyEnum.getEnumByCode(scoringStrategy) == null, ErrorCode.PARAMS_ERROR,"评分策略非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        ...
        if (reviewStatus!=null) {
            ThrowUtils.throwIf(ReviewStatusEnum.getEnumByCode(reviewStatus) == null, ErrorCode.PARAMS_ERROR,"审核状态非法");
        }
    }
